...
namespace CLGameServer.Client
{
    public partial class Packet
    {
        ...
        {
            DB ms = new DB("SELECT TOP 50 * FROM rank_job_activity WHERE job_type='1'");
        ...
        {
            DB ms = new DB("SELECT TOP 50 * FROM rank_job_donate WHERE job_type='1'");
            PacketWriter Writer = new PacketWriter();
            int countinfo = ms.Count();
            int i = 0;
        ...
        {
            DB ms = new DB("SELECT TOP 50 * FROM rank_job_donate WHERE job_type='3'");
            PacketWriter Writer = new PacketWriter();
            int countinfo = ms.Count();
            int i = 0;
        ...
        {
            DB ms = new DB("SELECT TOP 50 * FROM rank_job_donate WHERE job_type='2'");
            PacketWriter Writer = new PacketWriter();
            int countinfo = ms.Count();
            int i = 0;
