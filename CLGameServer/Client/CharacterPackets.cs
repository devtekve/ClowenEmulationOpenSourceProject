...
namespace CLGameServer.Client
{
    public partial class Packet
    {
        ...
        public static byte[] CharacterJobSelection()
        {
            PacketWriter writer = new PacketWriter();
            writer.Create(OperationCode.SERVER_CHARACTERSCREEN);
            writer.Byte(0x10);
            writer.Byte(1);
            return writer.GetBytes();
        }
        public static byte[] CharacterScreenJobs(double hunterpercentage, double thiefpercentage)
        {
            PacketWriter writer = new PacketWriter();
            writer.Create(OperationCode.SERVER_CHARACTERSCREEN);
            writer.Byte(9);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_LOGINSCREEN_ACCEPT);
            Writer.Byte(1);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_STARTPLAYERDATA);
            return Writer.GetBytes();
        }
        public static byte[] EndPlayerLoad()
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_ENDPLAYERDATA);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_SEND_WEATHER);
            Writer.Byte(type);
            Writer.Byte(speed);
            return Writer.GetBytes();
        }
        ...
        {
            TimeSpan ts = Helpers.Manager.ServerStartedTime - DateTime.Now;
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_CHARACTER_CELESTIAL_POSITION);
            Writer.DWord(id);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_SILKPACK);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_UNKNOWNINFO);
            Writer.Byte(2);
            Writer.Byte(3);
            Writer.DWord(1);
