...
namespace CLGameServer.Client
{
    public partial class Packet
    {
        public static byte[] ChangeStatus(int id, byte type, byte stand)
        {
            ...
            Writer.Create(OperationCode.SERVER_CHANGE_STATUS);
            if (type == 2)
            {
                Writer.DWord(id);
                Writer.Byte(1);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_QUESTMARK);
            Writer.DWord(ID);
            Writer.Byte(info);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_TRANSFORM);
            Writer.DWord(ID);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PVP_WAIT);
            Writer.DWord(userid);
            Writer.Byte(2);
            Writer.Byte(1);
            Writer.Byte(0x0A);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PVP_INTERUPT);
            Writer.DWord(userid);
            Writer.Byte(2);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PVP_DATA);
            Writer.Byte(1);
            Writer.DWord(userid);
            Writer.Byte(type);
            return Writer.GetBytes();
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PICKUPITEM_ANIM);  //Select opcode
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PLAYER_UPDATE_STR);
            Writer.Bool(true);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PLAYER_UPDATE_INT);
            Writer.Bool(true);
            return Writer.GetBytes();
        }
        ...
        public static byte[] SkillBirdAttack(int UniqueID,int DMG = 5000)
        {
            PacketWriter Write = new PacketWriter();
            Write.Create(OperationCode.SERVER_SKILL_BIRD_ATTACK);
            Write.DWord(890);
            Write.DWord(UniqueID);
            Write.Word(DMG);
            return Write.GetBytes();
        }
        public static byte[] Testeffect(int id,int HP = 0)
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_SKILL_EFFECTS);
            Writer.DWord(id);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_SKILL_UPDATE);
            Writer.Byte(1);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_EMOTE);
            Writer.DWord(id);
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_ITEM_STORAGE_BOX);
            Writer.Word(1);
            Writer.Word(1);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_ITEM_BOX_LOG);
            Writer.Byte(0);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_ITEM_REPAIR);
            Writer.Byte(slot);
            Writer.DWord(System.Convert.ToInt32(durability));
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_SELECT_OBJECT);
            Writer.Bool(true);
            Writer.DWord(id);
            switch (type)
            {
                case 1:
                    ...
                    break;
                case 2:
                    PlayerMgr.NPC.Chat(model, Writer);
                    break;
                case 3:
                    PlayerMgr.NPC.Chat(model, Writer);
                    break;
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PLAYER_LEVELUP_EFFECT);
            Writer.DWord(id);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PLAYER_HANDLE_EFFECT);
            Writer.DWord(id);
            Writer.DWord(itemid);
            return Writer.GetBytes();
        }
        ...
        {
            PacketWriter Writer = new PacketWriter();
            Writer.Create(OperationCode.SERVER_PLAYER_HANDLE_UPDATE_SLOT);
            Writer.Byte(1);
            Writer.Byte(slot);
            Writer.Word(amount);
            Writer.DWord(packet);
