...
namespace CLGameServer
{
    public partial class PlayerMgr
    {
        ...
        void HandleWareHouse(int itemid)
        {
            try
            {
                ...
                else
                {
                    ...
                    DB.query("UPDATE users SET warehouse_slots='" + warehouseslots + "' WHERE id='" + Player.AccountName + "'");
        ...
        // Open Warehouse
        /////////////////////////////////////////////////////////////////////////////////
        public void Open_Warehouse()
        {
            #region Open Warehouse
            try
            {
                client.Send(Packet.OpenWarehouse(Character.Account.StorageGold));
                client.Send(Packet.OpenWarehouse2(Character.Account.StorageSlots, Player));
