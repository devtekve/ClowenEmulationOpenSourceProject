        ...
        public void DonateGP()
        {
            ...
            try
            {
                ...
                if (Character.Network.Guild.Level == 5)
                {
                    ...
                    client.Send(Packet.Message(OperationCode.SERVER_GUILD_PROMOTE_MSG, Messages.UIIT_MSG_GUILD_LACK_GP));
                    return;
                }
                ...
                DB.query("UPDATE guild_members SET guild_points='" + Character.Network.Guild.DonateGP + "' WHERE guild_member_id='" + Character.Information.CharacterID + "'");
                //Send packets to donator.
                client.Send(Packet.InfoUpdate(1, totalgp, 0));
                //Send donated gp info
                PacketWriter writer = new PacketWriter();
                //Add opcode
                writer.Create(OperationCode.SERVER_GUILD_DONATE_GP);
                //Write static byte 1
                writer.Byte(1);
