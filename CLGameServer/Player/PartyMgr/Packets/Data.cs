...
namespace CLGameServer.Client
{
    public partial class Packet
    {
        ...
        public static byte[] PartyOwnerInformation(int leaderid)
        {
            ...
            PacketWriter Writer = new PacketWriter();
            //Add opcode
            Writer.Create(OperationCode.SERVER_PARTY_OWNER);
            //Static byte
            Writer.Byte(1);
        ...
        public static byte[] Party_Member(int memberid)
        {
            ...
            PacketWriter Writer = new PacketWriter();
            //Add opcode
            Writer.Create(OperationCode.SERVER_PARTY_MEMBER);
            //Static byte
            Writer.Byte(1);
        ...
        public static byte[] Party_DataMember(WorldMgr.party p)
        {
            //Create new packet writer
            PacketWriter Writer = new PacketWriter();
            //Add opcode
            Writer.Create(OperationCode.SERVER_PARTYMEMBER_DATA);
            //Write static byte
            Writer.Byte(0xFF);
            //Write party id
            Writer.DWord(p.ptid);
            ...
            for (byte b = 0; b <= p.Members.Count - 1; b++)
            {
                ...
                PlayerMgr PartyMemberInfo = Helpers.GetInformation.GetPlayer(p.Members[b]);
                //Calculate hp and mp
        ...
        public static byte[] Party_Data(byte type, int id)
        {
            ...
            PacketWriter Writer = new PacketWriter();
            //Add opcode
            Writer.Create(OperationCode.SERVER_PARTY_DATA);
            //Write type byte
            Writer.Byte(type);
            ...
            switch (type)
            {
                ...
                case 2:
                    ...
                    PlayerMgr CharacterInformation = Helpers.GetInformation.GetPlayer(id);
                    //Write static byte
                    Writer.Byte(0xFF);
                ...
                case 6:
                    ...
                    CharacterInformation = Helpers.GetInformation.GetPlayer(id);
                    //Calculate hp and mp
